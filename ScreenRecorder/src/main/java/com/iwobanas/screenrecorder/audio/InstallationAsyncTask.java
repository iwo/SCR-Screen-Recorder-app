...
public abstract class InstallationAsyncTask extends AsyncTask<Void, Void, InstallationStatus> {
    ...
    protected void onPreExecute() {
        super.onPreExecute();
        if (installId != null) {
            new AudioInstallationStatsAsyncTask(context, installId, initialStatus, null, 0).execute();
        }
    }
    ...
    protected void onPostExecute(InstallationStatus installationStatus) {
        ...
        if (installId != null) {
            ...
            new AudioInstallationStatsAsyncTask(context, installId, installationStatus, installer.getErrorDetails(), time).execute();
        }
    }
}
